...
public class EntertainmentFragment extends Fragment {
    private static EntertainmentFragment INSTANCE = null;
    ...
    public EntertainmentFragment() {
        ...
        newstem = database.getReference("EntertainmentItem");
    ...
    public static EntertainmentFragment getInstance() {
        if (INSTANCE == null)
            INSTANCE = new EntertainmentFragment();
        return INSTANCE;
